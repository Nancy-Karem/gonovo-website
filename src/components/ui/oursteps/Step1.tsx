  ...
  return (
    <div className="relative w-fit xl:w-full  bg-semiyellow rounded-[31px] h-auto xl:h-[443px]  xl:my-10 flex flex-col mx-auto">
      ...
      <div className="grid grid-cols-1 gap-8 xl:gap-0 xl:grid-cols-2 lg:px-10 lg:py-20 px-5 py-10 xl:px-20 h-full w-fit xl:w-full  justify-center">
        <div>
          <div className="rounded-[12px] sm:rounded-3xl  bg-white relative w-[65%] sm:w-[70%]  xl:w-[378px]">
            ...
            <div className="absolute xl:top-[-40px] sm:top-[-25px] sm:left-[100px] top-[-23px] left-[55px] xl:left-[200px] px-3 py-2 lg:px-4 lg:py-3 rounded-[10px] bg-semipurple flex w-max xl:scale-100  sm:scale-75 scale-50 items-center">
              <div>
